...
function theme_customize_register_companyprofile($wp_customize) {
    ...
    // テーマ設定（メニュー名の中の項目を設定）
    $wp_customize->add_setting('ratpost_theme_companyprofile_settings' , array(
        'default' => '',
        'type' => 'option',
        'transport' => 'refresh',
        'sanitize_callback' => 'sanitize_text_field'
    ...
    // コントロール設定
    $wp_customize->add_control('ratpost_theme_companyprofile_controls' , array(
        'settings' => 'ratpost_theme_companyprofile_settings',
        'label' => 'ボディーコピーを入力',
        'description' => 'トップページに表示するボディーコピーを入力してください。',
